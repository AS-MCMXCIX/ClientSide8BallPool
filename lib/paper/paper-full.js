...
var paper = function (self, undefined) {
    ...
    var PathItem = Item.extend({
        ...
        statics: {
            create: function (arg) {
                ...
                console.log(`####### In PathItem.create:\n arg be ${arg}\n#######`);
        ...
        setPathData: function (data) {
            ...
            for (var i = 0, l = parts && parts.length; i < l; i++) {
                ...
                // coords = SvgParser.parse(part)[0];
                // coords.shift();
                coords = part.match(/[+-]?(?:\d*\.\d+|\d+\.?)(?:[eE][+-]?\d+)?/g);

                if (lower === 'a' && coords.length !== 7) {
                    var t = coords.slice(3);
                    var last = t.pop();
                    var str = t.join("");
                    coords = coords.slice(0, 3).concat([str[0], str[1], str.slice(2), last]);
                    console.log(t);
                }
                ...
                switch (lower) {
                    ...
                    case 'a':
                        for (var j = 0; j < length; j += 7) {
                            let curr = getPoint(j + 5);
                            this.arcTo(current = curr,
    ...
    var CompoundPath = PathItem.extend({
            ...
            initialize: function CompoundPath(arg) {
                console.log("####### In CompoundPath.initialize");
                this._children = [];
                this._namedChildren = {};
                if (!this._initialize(arg)) {
